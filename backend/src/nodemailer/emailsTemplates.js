              ...
              <tbody>
                ...
                <tr>
                  <td style="padding:32px 32px 36px 32px;text-align:center;">
                    <h1 style="margin:0 0 12px 0;font-size:22px;line-height:30px;font-weight:700;">Verify your email address</h1>
                    <p style="margin:0 0 24px 0;font-size:15px;line-height:24px;color:#475569;">Welcome to Sawahel. Use the verification code below to confirm your email address.</p>
                    <div style="padding:20px 16px;border-radius:16px;background:#f1f5f9;">
                      <div style="margin:0 0 8px 0;font-size:13px;line-height:20px;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#475569;">Verification code</div>
                      <div style="margin:0;font-size:40px;line-height:44px;font-weight:800;letter-spacing:0.12em;color:#014769;">${verificationToken}</div>
                      <div style="margin:10px 0 0 0;font-size:14px;line-height:22px;color:#475569;">This code is valid for 24 hours.</div>
                    </div>
                  </td>
                </tr>
              </tbody>
          ...
          <td style="padding:24px;">
            <table align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 10px 30px rgba(15,23,42,0.08);">
              <tbody>
                ...
                <tr>
                  <td style="padding:32px 32px 36px 32px;text-align:center;">
                    <h1 style="margin:0 0 12px 0;font-size:22px;line-height:30px;font-weight:700;">Welcome to Sawahel</h1>
                    <p style="margin:0 0 12px 0;font-size:15px;line-height:24px;color:#475569;">Hi ${name},</p>
                    <p style="margin:0 0 24px 0;font-size:15px;line-height:24px;color:#475569;">Your account is ready! Explore our wide range of services and connect with verified professionals. Get started now and discover what Sawahel has to offer.</p>
                    <table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                      <tbody>
                        <tr>
                          <td style="text-align:center;">
                            <a href="https://sawahel.vercel.app/" target="_blank" rel="noreferrer" style="display:inline-block;padding:12px 32px;background-color:#0284c7;color:#ffffff;text-decoration:none;border-radius:8px;font-weight:600;font-size:15px;">Get Started</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
