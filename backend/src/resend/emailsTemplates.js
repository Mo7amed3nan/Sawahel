...
<html dir="ltr" lang="en">
  <head>
    <link
      rel="preload"
      as="image"
      href="https://react-email-demo-ai8rondhu-resend.vercel.app/static/aws-logo.png" />
                ...
                <tr style="width:100%">
                  <td>
                                ...
                                <tr>
                                  <td>
                                    <img
                                      alt="AWS&#x27;s Logo"
                                      height="45"
                                      src="https://react-email-demo-ai8rondhu-resend.vercel.app/static/aws-logo.png"
                    ...
                    <p
                      ...
                      2022, Amazon Web Services, Inc.. All rights reserved. AWS
...
<html dir="ltr" lang="en">
  ...
  <body style="background-color:rgb(255,255,255)">
              ...
              <tbody>
                <tr style="width:100%">
                  <td>
                    ...
                    <p
                      style="font-size:16px;line-height:26px;margin-top:16px;margin-bottom:16px">
                      Welcome to Sawahel, the multiservice platform that offers a wide range of services to meet all your needs in one place.
                    </p>
                    <table
                      align="center"
                      width="100%"
    ...
    <!--/$-->
    <script>
import { createIcons, waves } from 'lucide';
...
export const passwordResetTemplate = (resetUrl) => {
  return `<p> click the link the reset your password</p> 
